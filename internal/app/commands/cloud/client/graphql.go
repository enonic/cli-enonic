...
// Based on https://github.com/machinebox/graphql
...
func NewGQLClient(endpoint string, opts ...ClientOption) *GQLClient {
	c := &GQLClient{
		endpoint: endpoint,
		Log:      func(string) {},
	}
...
func (c *GQLClient) logf(format string, args ...interface{}) {
...
// will be returned.
func (c *GQLClient) Run(ctx context.Context, req *GQLRequest, resp interface{}) error {
	select {
	case <-ctx.Done():
		return ctx.Err()
	default:
...
func (c *GQLClient) runWithJSON(ctx context.Context, req *GQLRequest, resp interface{}) error {
...
func (c *GQLClient) runWithPostFields(ctx context.Context, req *GQLRequest, resp interface{}) error {
	var requestBody bytes.Buffer
...
func NewGQLRequest(q string) *GQLRequest {
	req := &GQLRequest{
		q:      q,
...
func (req *GQLRequest) Vars() map[string]interface{} {
	return req.vars
}
...
func (req *GQLRequest) Query() string {
	return req.q
}
