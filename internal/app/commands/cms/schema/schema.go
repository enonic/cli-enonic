...
type kind struct {
	...
	icon     bool   // resources of this kind can have an icon
}

var kinds = []kind{
	{"content-type", "ContentType", "schemas", true, true, true},
	{"form-fragment", "FormFragment", "schemas", true, true, true},
	{"mixin", "Mixin", "schemas", true, true, true},
	{"part", "Part", "components", true, true, true},
	{"layout", "Layout", "components", true, true, false},
	{"page", "Page", "components", true, true, false},
	{"macro", "Macro", "macros", false, true, true},
	{"style", "Style", "styles", false, false, false},
	{"cms", "CMS", "cms", false, false, false},
	{"phrases", "", "phrases", false, true, false},
}
