...
IMPORTANT: If you see a warning that Apple cannot verify the binary, run:                                                                                                                                    
                                                                                                                                                                                                    
 xattr -d com.apple.quarantine $(which enonic)                                                                                                                                                     
                                                                                                                                                                                                    
Alternatively, go to System Settings → Privacy & Security and click "Allow Anyway" next to the blocked message, then run enonic again.
