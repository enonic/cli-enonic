...
...or you can install it from Snapcraft:

 $ sudo snap install enonic

...or, if you know exact version you need, you can download CLI binary directly from our repository:
...
----
$ enonic app install -a su:password -u https://repo.enonic.com/public/com/enonic/app/superhero/1.2.0/superhero-1.2.0.jar
----
...
Loading...
Local version: 1.1.0.
Latest available version is 1.1.0.
----
